...
date: "2026-02-01"
categories: [Pessoal, Concluído, .NET, PostgreSQL, Blazor]
about:
  template: solana
  links:
    - icon: github
...
## Status do Projeto: **Pessoal / Concluído**
Projeto colaborativo desenvolvido para criação de software Web de gestão de salas interativas para assistir videos online.
:::
